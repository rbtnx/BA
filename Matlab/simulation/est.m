function [est_tv,est_q,est_dt] = est(number,start,ende)
    ...
    if number == 1
        ...
        est_dt = iddata(dt',[wae.waerme.Q1(start:ende);1./wmz.WMZ.WMZ1.c0044(start:ende)]',60);
    ...
    elseif number == 2
        ...
        est_dt = iddata(dt',[wae.waerme.Q2(start:ende);1./wmz.WMZ.WMZ2.c0070(start:ende)]',60);
    elseif number == 3
        ...
        est_dt = iddata(dt',[wae.waerme.Q3(start:ende);1./wmz.WMZ.WMZ3.c0178(start:ende)]',60);
    elseif number == 4
        ...
        est_dt = iddata(dt',[wae.waerme.Q4(start:ende);1./wmz.WMZ.WMZ4.c0196(start:ende)]',60);
    elseif number == 5
        ...
        est_dt = iddata(dt',[wae.waerme.Q5(start:ende);1./wmz.WMZ.WMZ5.c0062(start:ende)]',60);
    end
