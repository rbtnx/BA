...
\end{equation}
mit dem Massenstrom $\dot{m}$, der Dichte von Wasser $\rho$ und dem Volumenstrom $\dot{V}$ . Das so im sogenannten Verbraucher abgekühlte Wasser wird erneut dem Wärmeerzeuger zugeführt, wo das Heizungswasser Wärme aufnimmt und der Heizkreislauf von neuem beginnt,\cite{TBHK90}. Auf die Begriffe der Erzeuger und Verbraucher eines Heizkreises wird nachfolgend genauer eingegangen.
